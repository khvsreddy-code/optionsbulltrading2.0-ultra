...
const PortfolioPanel: React.FC<PortfolioPanelProps> = ({ portfolio, onPositionClick, onReversePosition }) => {
  ...
  return (
    <div className="flex flex-col">
      {/* Table Header */}
      <div className="grid grid-cols-12 gap-4 px-4 py-2 text-xs font-semibold text-slate-400 border-b border-slate-700/50 bg-[#131722] sticky top-0">
      ...
      <ul className="divide-y divide-slate-800">
        {portfolio.positions.map(pos => {
          ...
          return (
            <li key={pos.instrument.instrument_key} className="hover:bg-slate-800/50">
