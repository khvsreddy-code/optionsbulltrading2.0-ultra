...
export const Sparkles: React.FC<IconProps> = ({ size = 24, className = '' }) => (
    ...
    >
        ...
        <path d="M18 15L17.25 17L15 17.75L17.25 18.5L18 20.75L18.75 18.5L21 17.75L18.75 17L18 15Z"/>
...
export const Paperclip = createIcon(<><path d="m21.44 11.05-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48" /></>);
