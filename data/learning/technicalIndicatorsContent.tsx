    ...
    },
    {
        ...
        content: (
            <>
                ...
                <h4 className="text-xl font-semibold mt-6 mb-2">Deep Learning & Psychology</h4>
                <p className="mb-4">TRIN quantifies the severity and conviction of market-wide buying or selling pressure. A reading below 1.0 is considered strongly bullish, as it indicates that the volume is disproportionately concentrated in advancing (rising) stocks. A reading above 1.0 is bearish. Extreme readings are often contrarian signals. An extremely low reading (e.g., below 0.5) can signal a buying climax or over-enthusiasm, while an extremely high reading (e.g., above 2.0) often signals a panic selling climax and a high-probability short-term bottom, as sellers have been completely exhausted by immediate buying volume.</p>
            </>
        ),
    },
    {
