...
const PrivacyPolicyView: React.FC<PrivacyPolicyViewProps> = ({ onNavigate }) => {
    return (
        <PolicyPageLayout title="Privacy Policy" onNavigate={onNavigate}>
            ...
            <p>
                This privacy policy sets out how KALAMAKUNTLA HARINATHA REDDY uses and protects any information that you give KALAMAKUNTLA HARINATHA REDDY when you visit their website and/or agree to purchase from them. KALAMAKUNTLA HARINATHA REDDY is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, and then you can be assured that it will only be used in accordance with this privacy statement.
            </p>
            <p>
                KALAMAKUNTLA HARINATHA REDDY may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you adhere to these changes.
            </p>
